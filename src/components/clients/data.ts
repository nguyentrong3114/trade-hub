...
export const CLIENT_DETAILS: ClientDetail[] = [
  {
    ...
    // Extended fields for video section and pricing snapshot
    ...
    clientFeedback:
      "TechNova Solutions được đánh giá cao về việc cung cấp giá trị tốt so với chi phí, với nhiều khách hàng ghi nhận rằng mức giá của họ phù hợp với ngân sách. Chi phí dự án cụ thể dao động từ $43,000 đến hơn $1 triệu, với các đội ngũ thường bao gồm 2-50 nhân viên. Giao tiếp mạnh mẽ và giao hàng đúng hạn của họ càng làm tăng giá trị cảm nhận. Tóm tắt này dựa trên các đánh giá đã được xác minh từ Clutch.",
    services: [
      "all",
...
export const DEFAULT_CLIENT: Omit<ClientDetail, "id" | "name" | "description" | "logo" | "category" | "rank"> = {
  slogan: "Đối tác tin cậy của B2B",
  coverImage: "/img/section1.jpg",
  overview: "Đối tác chiến lược của B2B, cùng nhau xây dựng hệ sinh thái giao dịch an toàn và hiệu quả.",
